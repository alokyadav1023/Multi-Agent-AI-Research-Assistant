...
DEFAULT_NVIDIA_MODEL = os.getenv("DEFAULT_NVIDIA_MODEL", "nvidia/nemotron-3-nano-30b-a3b")
...
MAX_TOTAL_SOURCES = int(os.getenv("MAX_TOTAL_SOURCES", "12"))
MAX_SCRAPED_CHARS = int(os.getenv("MAX_SCRAPED_CHARS", "3000"))

# Graph Workflow settings
DEFAULT_MAX_ITERATIONS = int(os.getenv("DEFAULT_MAX_ITERATIONS", "1"))
